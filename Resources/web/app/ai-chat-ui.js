...
export const initAiChatUi = (context, deps) => {
    ...
    const getChatMode = (chatId) => {
        var _a;
        const chat = getChat(chatId);
        return (_a = chat === null || chat === void 0 ? void 0 : chat.mode) !== null && _a !== void 0 ? _a : defaultChatMode;
    };
    const isAutoPilotEnabled = (chatId) => {
        const chat = getChat(chatId);
        return Boolean(chat === null || chat === void 0 ? void 0 : chat.autoPilot);
    };
    function syncModeControls() {
        var _a;
        const chat = getChat(activeChatId);
        const mode = (_a = chat === null || chat === void 0 ? void 0 : chat.mode) !== null && _a !== void 0 ? _a : defaultChatMode;
        const autoPilot = Boolean(chat === null || chat === void 0 ? void 0 : chat.autoPilot);
    ...
    const createChat = () => createChatState({
        chats,
        chatIndex,
        makeChatId,
        resolveChatTitle,
    ...
    const buildOpenFilesContext = () => {
        ...
        const openSnapshots = (_a = deps.getOpenFileSnapshots) === null || _a === void 0 ? void 0 : _a.call(deps, {
    ...
    const buildAgentModeContext = (chatId) => ({
    ...
    const setPendingProposalId = (value) => {
    ...
    const canRunInChat = (chatId) => {
        if (!chatId) {
            return false;
        }
        return !runningConversationId;
    };
    const buildContinueMessage = (chatId) => {
    ...
    const requestAgentRun = (chatId, message) => {
        if (!message.trim()) {
            return;
        }
    ...
    const handleApplyResult = (payload) => {
        ...
        if (payload.ok) {
            ...
            const proposals = getProposalsContainer();
            (_a = proposals === null || proposals === void 0 ? void 0 : proposals.querySelector(`[data-proposal-id="${payload.proposalId}"]`)) === null || _a === void 0 ? void 0 : _a.remove();
            ...
            const shouldContinue = chat.proposals.size === 0 &&
