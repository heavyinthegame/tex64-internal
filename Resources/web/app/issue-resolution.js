const rules = [
    ...
    {
        test: (_issue, message) => /class\s+revtex4-2\s+warning:\s+no type size specified/i.test(message),
        resolution: "documentclass のオプションに文字サイズを指定してください（例: \\documentclass[10pt]{revtex4-2}）。",
    },
    {
