export const getDomRefs = () => ({
    ...
    settingsRuntimeOnboardingStatus: document.getElementById("settings-runtime-onboarding-status"),
    settingsRuntimeRunFirstBuild: document.getElementById("settings-runtime-run-first-build"),
    settingsRuntimeOpenGettingStarted: document.getElementById("settings-runtime-open-getting-started"),
    ...
    settingsFeedbackIncludeDiagnostics: document.getElementById("settings-feedback-include-diagnostics"),
    ...
    deleteModalTarget: document.getElementById("delete-modal-target"),
    deleteModalHelp: document.getElementById("delete-modal-help"),
    deleteModalCancel: document.getElementById("delete-modal-cancel"),
    deleteModalSubmit: document.getElementById("delete-modal-submit"),
