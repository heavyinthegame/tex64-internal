        ...
        candidates: [
            {
                ...
                label: "subequations",
                displayLatex: "\\begin{subequations}\\begin{aligned}a &= b\\\\c &= d\\end{aligned}\\end{subequations}",
            },
        ],
    },
    {
        ...
        candidates: [
            ...
            },
            {
                ...
                label: "array{...}",
                displayLatex: "\\begin{array}{@{}>r<{}c@{|}l<{}@{}}a&b&c\\\\d&e&f\\end{array}",
            },
        ],
    },
    {
...
const buildTriggerMap = () => {
    ...
    const addAliasCandidates = (alias, canonical, priorityBoost = 0) => {
        ...
        canonicalGroup.candidates.forEach((candidate) => {
            ...
            if (!(aliasGroup === null || aliasGroup === void 0 ? void 0 : aliasGroup.candidates.some((item) => item.id === aliasCandidate.id))) {
                aliasGroup === null || aliasGroup === void 0 ? void 0 : aliasGroup.candidates.push(aliasCandidate);
            }
        });
